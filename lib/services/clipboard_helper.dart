...
class ClipboardPasteHelper {
  ...
  Future<bool> _pasteFile(String sourcePath, String relativeDir) async {
    try {
      ...
      // Encrypt and write
      fileService.secWriteFile(sessionID, targetRelativePath, data);
    ...
    await for (final entity in sourceDir.list(recursive: true)) {
      ...
      if (entity is File) {
        ...
        try {
          ...
          fileService.secWriteFile(sessionID, targetPath, data);
...
class ClipboardCopyHelper {
  ...
  Future<void> _exportFile(FileSystemNode item, String exportPath) async {
    ...
    final data = fileService.secReadFile(sessionID, relativePath);
  ...
  Future<void> _exportDirectory(FileSystemNode item, String exportPath) async {
    ...
    final walker = DirectoryService().secWalkDirectory(sessionID, relativePath);
    ...
    for (final entry in entries) {
      if (entry.isDir) {
        ...
        final data = fileService.secReadFile(sessionID, entryRelativePath);
