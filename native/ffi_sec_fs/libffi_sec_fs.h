...
extern char* sec_webdav_open_with_options(int64_t rootID, char* exposedPath, char* displayName, char* optionsJSON);
extern char* sec_webdav_close(char* sessionID);
extern char* sec_webdav_reveal(char* sessionID);
extern char* sec_webdav_list(int64_t rootID);
extern char* sec_webdav_mount(char* sessionID);
extern char* sec_webdav_unmount(char* sessionID);
extern char* sec_webdav_mount_start(char* operationID, char* sessionID);
