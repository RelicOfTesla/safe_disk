...
7. [开发路线图](ROADMAP.md)
8. [任务列表](TODO.md)
9. [验证状态](VERIFICATION_STATUS.md)
10. [跨平台验收清单](PLATFORM_ACCEPTANCE.md)
11. [已完成任务](completed/TASKS_COMPLETED.md)
...
| [VERIFICATION_STATUS.md](VERIFICATION_STATUS.md) | 当前有效的验证基线、命令口径和环境限制 | 当前有效，不记录活跃任务进度 |
